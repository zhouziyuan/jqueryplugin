...
function() {
    return function(e) {
        ...
        e.exports = {
            ...
            getElementViewLeft: function(e) {
                ...
                if (document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement) for (; null !== i && i !== e;) t += i.offsetLeft,
                i = i.offsetParent;
                else for (; null !== i;) t += i.offsetLeft,
                i = i.offsetParent;
                return t - n
            },
    ...
    function(e, t, i) {
        ...
        z = function() {
            ...
            default({
                ...
                var n = {};
                n.volumeBar = this.template.volumeBar,
                n.playedBar = this.template.playedBar,
                n.loadedBar = this.template.loadedBar;
                var s = void 0;
                if (this.updateBar = function(e, t, i) {
                    t = t > 0 ? t: 0,
                    t = t < 1 ? t: 1,
                    n[e + "Bar"].style[i] = 100 * t + "%"
                },
                document.addEventListener("click",
                function() {
                    i.focus = !1
                },
                !0), this.container.addEventListener("click",
                function() {
                    i.focus = !0
                },
                !0), this.options.danmaku && (this.danmaku = new f.
            default({
                    container:
                    ...
                    callback: function() {
                        setTimeout(function() {
                            i.template.danmakuLoading.style.display = "none",
                            i.options.autoplay && !o.isMobile ? i.play() : o.isMobile && i.pause()
                        },
                        0)
                    },
                    error: function(e) {
                    ...
                    r.innerHTML = ".dplayer .dplayer-danmaku{font-size:18px}",
                    document.head.appendChild(r)
                }
                if (this.video = this.template.video, this.template.bezel.addEventListener("animationend",
                function() {
                    i.template.bezel.classList.remove("dplayer-bezel-transition")
                }), this.paused = !0, this.template.playButton.addEventListener("click",
                function() {
                    i.toggle()
                }), o.isMobile) {
                    var d = function() {
                    ...
                    this.template.videoWrap.addEventListener("click", d),
                    this.template.controllerMask.addEventListener("click", d)
                } else this.template.videoWrap.addEventListener("click",
                function() {
                    i.toggle()
                }),
                ...
                var g = function() {
                    i.checkLoading = setInterval(function() {
                        m = i.video.currentTime,
                        v || m !== p || i.video.paused || (i.container.classList.add("dplayer-loading"), v = !0),
                        v && m > p && !i.video.paused && (i.container.classList.remove("dplayer-loading"), v = !1),
                        p = m
                    },
                    100)
                },
                ...
                this.animationFrame = function() {
                    i.playedTime && (i.updateBar("played", i.video.currentTime / i.video.duration, "width"), i.template.ptime.innerHTML = l.
                default.secondToTime(i.video.currentTime)),
                    window.requestAnimationFrame(i.animationFrame)
                },
                ...
                var k = function(e) {
                    var t = (e.clientX - l.
                default.getElementViewLeft(i.template.playedBarWrap)) / s;
                    t = t > 0 ? t: 0,
                    t = t < 1 ? t: 1,
                    i.updateBar("played", t, "width"),
                    i.template.ptime.innerHTML = l.
                default.secondToTime(t * i.video.duration)
                },
                L = function e(t) {
                ...
                default.getElementViewLeft(i.template.playedBarWrap)) / s;
                    a = a > 0 ? a: 0,
                    a = a < 1 ? a: 1,
                    i.updateBar("played", a, "width"),
                    i.seek(parseFloat(n.playedBar.style.width) / 100 * i.video.duration),
                    i.setTime()
                };
                this.template.playedBarWrap.addEventListener("mousedown",
                function() {
                    s = i.template.playedBarWrap.clientWidth,
                    i.clearTime(),
                ...
                var S = function(e) {
                    ...
                    n = (t.clientX - l.
                default.getElementViewLeft(i.template.volumeBarWrap) - 5.5) / 35;
                    i.volume(n)
                },
                T = function e() {
                    document.removeEventListener("mouseup", e),
                    document.removeEventListener("mousemove", S),
                    i.template.volumeButton.classList.remove("dplayer-volume-active")
                };
                this.template.volumeBarWrapWrap.addEventListener("click",
                function(e) {
                    var t = e || window.event,
                    n = (t.clientX - l.
                default.getElementViewLeft(i.template.volumeBarWrap) - 5.5) / 35;
                ...
                function() {
                    ...
                    i.template.volumeButton.classList.add("dplayer-volume-active")
                }),
                ...
                this.hideTime = 0;
                var E = function() {
                    i.container.classList.remove("dplayer-hide-controller"),
                    clearTimeout(i.hideTime),
                    i.hideTime = setTimeout(function() {
                ...
                var z = function() {
                    i.template.settingBox.classList.contains("dplayer-setting-box-open") && (i.template.settingBox.classList.remove("dplayer-setting-box-open"), i.template.mask.classList.remove("dplayer-mask-show"), setTimeout(function() {
                        i.template.settingBox.classList.remove("dplayer-setting-box-narrow"),
                        i.template.settingBox.classList.remove("dplayer-setting-box-speed")
                    },
                    300)),
                    i.disableHideController = !1
                },
                F = function() {
                    i.disableHideController = !0,
                    i.template.settingBox.classList.add("dplayer-setting-box-open"),
                    i.template.mask.classList.add("dplayer-mask-show")
                };
                ...
                if (this.template.loopToggle.checked = this.loop, this.template.loop.addEventListener("click",
                function() {
                    i.template.loopToggle.checked = !i.template.loopToggle.checked,
                    i.template.loopToggle.checked ? i.loop = !0 : i.loop = !1,
                    z()
                }), this.template.showDanmakuToggle.checked = _, this.template.showDanmaku.addEventListener("click",
                function() {
                    i.template.showDanmakuToggle.checked = !i.template.showDanmakuToggle.checked,
                    i.template.showDanmakuToggle.checked ? (_ = !0, i.paused || i.danmaku.show()) : (_ = !1, i.danmaku.hide()),
                    i.user.set("danmaku", _ ? 1 : 0),
                    z()
                }), this.template.unlimitDanmakuToggle.checked = C, this.template.unlimitDanmaku.addEventListener("click",
                function() {
                    i.template.unlimitDanmakuToggle.checked = !i.template.unlimitDanmakuToggle.checked,
                    i.template.unlimitDanmakuToggle.checked ? (C = !0, i.danmaku.unlimit(!0)) : (C = !1, i.danmaku.unlimit(!1)),
                    i.user.set("unlimited", C ? 1 : 0),
                    z()
                }), this.template.speed.addEventListener("click",
                function() {
                    i.template.settingBox.classList.add("dplayer-setting-box-narrow"),
                    i.template.settingBox.classList.add("dplayer-setting-box-speed");
                    for (var e = 0; e < i.template.speedItem.length; e++) !
                    function(e) {
                        i.template.speedItem[e].addEventListener("click",
                        function() {
                            i.video.playbackRate = i.template.speedItem[e].dataset.speed,
                            z()
                        })
                    } (e)
                }), this.danmaku) {
                    n.danmakuBar = this.template.danmakuOpacityBar;
                    this.on("danmaku_opacity",
                    function(e) {
                        i.updateBar("danmaku", e, "width"),
                        i.user.set("opacity", e)
                    }),
                    this.danmaku.opacity(this.user.get("opacity"));
                    var D = function(e) {
                        var t = e || window.event,
                        n = (t.clientX - l.
                    default.getElementViewLeft(i.template.danmakuOpacityBarWrap)) / 130;
                        n = n > 0 ? n: 0,
                        n = n < 1 ? n: 1,
                        i.danmaku.opacity(n)
                    },
                    P = function e() {
                        ...
                        i.template.danmakuOpacityBox.classList.remove("dplayer-setting-danmaku-active")
                    };
                    this.template.danmakuOpacityBarWrapWrap.addEventListener("click",
                    function(e) {
                        var t = e || window.event,
                        n = (t.clientX - l.
                    default.getElementViewLeft(i.template.danmakuOpacityBarWrap)) / 130;
                    ...
                    function() {
                        ...
                        i.template.danmakuOpacityBox.classList.add("dplayer-setting-danmaku-active")
                    })
                }
                1 !== this.video.duration && (this.template.dtime.innerHTML = this.video.duration ? l.
            default.secondToTime(this.video.duration):
                "00:00"),
                ...
                O = function() {
                    i.disableHideController = !0,
                    i.template.controller.classList.contains("dplayer-controller-comment") || (i.template.controller.classList.add("dplayer-controller-comment"), i.template.mask.classList.add("dplayer-mask-show"), i.container.classList.add("dplayer-show-controller"), i.template.commentInput.focus())
                };
                this.template.mask.addEventListener("click",
                function() {
                    H()
                ...
                function() {
                    if (i.template.commentColorSettingBox.querySelector("input:checked+span")) {
                        ...
                        i.template.commentSettingFill.style.fill = e,
                        i.template.commentInput.style.color = e,
                        i.template.commentSendFill.style.fill = e
                    }
                });
                var A = function() {
                ...
                this.template.commentInput.addEventListener("keydown",
                function(e) {
                    13 === (e || window.event).keyCode && A()
                }),
                this.template.commentSendButton.addEventListener("click", A),
                this.fullScreen = new x.
            default(this),
                ...
                this.options.hotkey && document.addEventListener("keydown", V),
                ...
                function(e) {
                    var t = e || window.event;
                    t.preventDefault(),
                    i.template.menu.classList.add("dplayer-menu-show");
                    var n = i.container.getBoundingClientRect(),
                    a = t.clientX - n.left,
                    s = t.clientY - n.top;
                    a + i.template.menu.offsetWidth >= n.width ? (i.template.menu.style.right = n.width - a + "px", i.template.menu.style.left = "initial") : (i.template.menu.style.left = t.clientX - i.container.getBoundingClientRect().left + "px", i.template.menu.style.right = "initial"),
                    s + i.template.menu.offsetHeight >= n.height ? (i.template.menu.style.bottom = n.height - s + "px", i.template.menu.style.top = "initial") : (i.template.menu.style.top = t.clientY - i.container.getBoundingClientRect().top + "px", i.template.menu.style.bottom = "initial"),
                    i.template.mask.classList.add("dplayer-mask-show"),
                    i.events.trigger("contextmenu_show"),
                    i.template.mask.addEventListener("click",
                    function() {
                        i.template.mask.classList.remove("dplayer-mask-show"),
                        i.template.menu.classList.remove("dplayer-menu-show"),
                        i.events.trigger("contextmenu_hide")
                    })
                }),
                this.options.video.quality && this.template.qualityList.addEventListener("click",
                function(e) {
                    e.target.classList.contains("dplayer-quality-item") && i.switchQuality(e.target.dataset.index)
                }),
                this.options.screenshot && this.template.camareButton.addEventListener("click",
                function() {
                    var e = document.createElement("canvas");
                    e.width = i.video.videoWidth,
                    e.height = i.video.videoHeight,
                    e.getContext("2d").drawImage(i.video, 0, 0, e.width, e.height);
                    var t = e.toDataURL();
                    i.template.camareButton.href = t,
                    i.template.camareButton.download = "DPlayer.png",
                    i.events.trigger("screenshot", t)
                }),
                this.options.subtitle && (this.events.on("subtitle_show",
                function() {
                    i.template.subtitleButton.dataset.balloon = i.tran("Hide subtitle"),
                    i.template.subtitleButtonInner.style.opacity = "",
                    i.user.set("subtitle", 1)
                }), this.events.on("subtitle_hide",
                function() {
                    i.template.subtitleButton.dataset.balloon = i.tran("Show subtitle"),
                    i.template.subtitleButtonInner.style.opacity = "0.4",
                    i.user.set("subtitle", 0)
            ...
            },
            {
                ...
                value: function() {
                    ...
                    this.video.paused || (this.template.bezel.innerHTML = this.icons.get("pause"), this.template.bezel.classList.add("dplayer-bezel-transition")),
                    this.ended = !1,
            ...
            },
            {
                ...
                value: function(e, t, i) {
                    if (e = parseFloat(e), !isNaN(e)) {
                        ...
                        i || this.notice(this.tran("Volume") + " " + (100 * e).toFixed(0) + "%"),
                        this.video.volume = e,
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    t && (this.template.danmakuLoading.style.display = "block", this.updateBar("played", 0, "width"), this.updateBar("loaded", 0, "width"), this.template.ptime.innerHTML = "00:00", this.template.danmaku.innerHTML = "", this.danmaku && this.danmaku.reload({
                        id: t.id,
                        address: t.api,
                        token: t.token,
                        maximum: t.maximum,
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    function() {
                        1 !== e.duration && (i.template.dtime.innerHTML = l.
                    ...
                    this.on("ended",
                    function() {
                        i.updateBar("played", 1, "width"),
                        i.loop ? (i.seek(0), e.play()) : (i.ended = !0, i.pause()),
                        i.danmaku && (i.danmaku.danIndex = 0)
                    }),
                    this.on("play",
                    function() {
                        i.paused && i.play()
                    ...
                    for (var n = 0; n < this.events.videoEvents.length; n++) !
                    function(t) {
                        e.addEventListener(i.events.videoEvents[t],
                        function() {
                            i.events.trigger(i.events.videoEvents[t])
                        })
                    } (n);
                    this.volume(this.user.get("volume"), !0, !0),
                    this.options.subtitle && (this.subtitle = new E.
                        ...
                        if (i.video.duration) {
                            ...
                            if (! (r < 0 || r > e.offsetWidth)) {
                                ...
                                case "mouseenter":
                                    ...
                                    break;
                                case "mousemove":
                                    i.thumbnails && i.thumbnails.move(r),
                                    t.innerText = l.
                                default.secondToTime(c),
                                    i.timeTipsDisplay(!0, t);
                                    break;
                                case "mouseleave":
                                    i.thumbnails && i.thumbnails.hide(),
                                    i.timeTipsDisplay(!1, t)
                                }
                            }
                        }
                    }
            ...
            },
            {
                ...
                value: function() {
                    var e = this;
                    this.thumbnails = new b.
                default(this.template.barPreview, this.template.barWrap.offsetWidth, this.options.video.thumbnails, this.events),
    ...
    function(e, t, i) {
        ...
        a = i(5);
        e.exports = function(e) { / mobile / i.test(window.navigator.userAgent) && (e.autoplay = !1);
            var t = {
            ...
            "object" === n(e.danmaku) && e.danmaku && !e.danmaku.user && (e.danmaku.user = "DIYgod"),
    ...
    function(e, t, i) {
        ...
        s = function() {
            ...
            },
            {
                ...
                value: function(e, t) {
                    for (var i = '<div class="dplayer-menu">',
                    n = 0; n < e.length; n++) i += '<div class="dplayer-menu-item"><a target="_blank" href="' + e[n].link + '">' + t(e[n].text) + "</a></div>";
                    return i += "</div>"
                }
            },
            {
                key: "tplQualityList",
                value: function(e) {
                    for (var t = '<div class="dplayer-quality-list">',
                    i = 0; i < e.length; i++) t += '<div class="dplayer-quality-item" data-index="' + i + '">' + e[i].name + "</div>";
                    return t += "</div>"
                }
            },
            {
        ...
        o = function() {
            ...
            return s(e, [{
                ...
                value: function() {
                    ...
                    i.push(t),
                    this.events && this.events.trigger("danmaku_load_start", i),
                    this._readAllEndpoints(i,
                    function(t) {
            ...
            },
            {
                ...
                value: function(e, t) {
                    for (var i = this,
                    n = [], a = 0, s = 0; s < e.length; ++s) this.options.apiBackend.read(e[s],
                    function(s) {
                        return function(o, l) {
            ...
            },
            {
                ...
                value: function(e, t) {
                    ...
                    this.options.apiBackend.send(this.options.api.address, i, t),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    if (this.dan.length && !this.paused && this.showing) {
                        for (var t = this.dan[this.danIndex], i = []; t && this.options.time() > parseFloat(t.time);) i.push(t),
            ...
            },
            {
                ...
                value: function(e) {
                    ...
                    if (this.showing) {
                        ...
                        c = function(e, i, s) {
                            for (var c = n / r(s), d = 0; t.unlimited || d < o; d++) {
                                var u = function(a) {
                                    ...
                                    if (!s || !s.length) return t.danTunnel[i][a + ""] = [e],
                                    ...
                                    for (var d = 0; d < s.length; d++) {
                                        ...
                                        if (d === s.length - 1) return t.danTunnel[i][a + ""].push(e),
                                        e.addEventListener("animationend",
                                        function() {
                                            t.danTunnel[i][a + ""].splice(0, 1)
                                        }),
                        ...
                        for (var d = document.createDocumentFragment(), u = 0; u < e.length; u++) !
                        function(a) {
                            ...
                            case "right":
                                l = c(s, e[a].type, o),
                                l >= 0 && (s.style.width = o + 1 + "px", s.style.top = i * l + "px", s.style.transform = "translateX(-" + n + "px)");
                                break;
                            case "top":
                                l = c(s, e[a].type),
                                l >= 0 && (s.style.top = i * l + "px");
                                break;
                            case "bottom":
                                l = c(s, e[a].type),
                                l >= 0 && (s.style.bottom = i * l + "px");
                                break;
                            default:
            ...
            },
            {
                ...
                value: function() {
                    ...
                    t = this.container.getElementsByClassName("dplayer-danmaku-item"), i = 0; i < t.length; i++) t[i].style.transform = "translateX(-" + e + "px)"
                }
            },
            {
                key: "hide",
    ...
    function(e, t, i) {
        ...
        l = function() {
            function e(t) {
                ...
                var a = function() {
                    i.player.resize(),
                    i.isFullScreen("browser") ? i.player.events.trigger("fullscreen") : i.player.events.trigger("fullscreen_cancel")
                };
            ...
            },
            {
                ...
                value: function() {
                    ...
                    case "web":
                        ...
                        o.
                    default.setScrollPosition(this.lastScrollPosition),
